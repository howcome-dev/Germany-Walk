  ...
  <main class="ly_wrapper">
    <section class="ly_wrapper_conts bl_mag">
      ...
      <form class="bl_mag_form" method="post" action="">
        <fieldset class="bl_mag_form_ttl">
          <legend>
        ...
        <p class="bl_mag_form_submit">
          <button class="ly_btn" name="btn_submit" type="button">送信</button>
          <button class="ly_btn" name="btn_back" type="button">入力画面に戻る</button>
        </p>
      ...
      <form class="bl_mag_form" method="post" action="">
        <fieldset class="bl_mag_form_ttl">
          ...
          <input class="bl_mag_form_txtfield" name="last_name" type="text" placeholder="姓 Family Name">
          <input class="bl_mag_form_txtfield" name="first_name" type="text" placeholder="名 First Name">
        </fieldset>
        <p class="bl_mag_form_ttl">
          <span class="bl_mag_form_labelTxt">メールアドレス Mail</span>
          <input class="bl_mag_form_txtfield" name="email" type="text" placeholder="xxxx@germanywalk.com">
        </p>
        <p class="bl_mag_form_ttl">
          <span class="bl_mag_form_labelTxt">メッセージ Message</span>
          <textarea class="bl_mag_form_txtarea" name="message" rows="8" placeholder="最大文字数1000字まで。熱い想いを語ってください。"></textarea>
        <p class="bl_mag_form_submit">
          <button class="ly_btn" name="btn_confirm" type="button">入力内容を確認する</button>
        </p>
      </form>
